...
function singleTag({ tag, posts, count, current }) {
  return (
    <>
...
export async function getServerSideProps({ params, res }) {
  try {
    ...
    const postsRes = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/posts?tags.slug=${tagSlug}&_limit=${process.env.NEXT_PUBLIC_POSTS_PER_PAGE}&_start=${skipLimit}`
    )
